...
class Mote(object):
    ...
    def __init__(self, id, eui64=None):
        ...
        self.roupe                     = RoutingPerm.Roupe(self)
    ...
    # Appel de la methode MemoireGlobal cree dans le fichier app.py
    def NombreTotalDePacket(self):
        
        self.app.NombreTotalDePacket() 
    ...
    def boot(self):
        ...
        #trace.write("Demarrage du service boot OK "+str(self.id) +"\n" )
        #trace.write("***** \n" )
        
        # Appel de la methode motelist cree dans le fichier app.py
        self.app.motelist()    
        ...
        if self.dagRoot:
            ...
            # roupe
            #trace = open("Dossier/FichierDeTrace.txt","a")
            #trace.write("start routing permutation OK \n" )
            #trace.write("***** \n" )
            self.roupe.start()
    ...
    def clear_to_send_EBs_DATA(self):
        ...
        if returnVal is True:
            if (
                    ...
                    and
                    (self.roupe.getPreferredParent() is None)
                ):
                returnVal = False
    ...
    def drop_packet(self, packet, reason):
       ...
       # trace = open("Dossier/FichierDeTrace.txt","a")
        #trace.write(" NOEUD AYANT PERDU LES PAQUETS \n")
       # trace.write("Identite du Noeud :")
        #trace.write(str(self.id))
        #trace.write("\n************** \n" )
        #trace.write(" La raison :")
        #trace.write(str(reason))
        #trace.write("\n************* \n" )
        #trace.write("************* \n" )
        #trace.close()
    ...
    def _init_eui64(self, eui64):
        ...
        #trace.write(str(self.id))
        #trace.write("\t* \n" )
        #trace.write("addresse mac :")
        #trace.write(str(self.MAC_ADDR_TYPE_EUI64))
        #trace.write("\t* \n" )
        #trace.write("addresse ipv6 :")
        #trace.write(str(self.get_ipv6_link_local_addr()))
        #trace.write("* \n" )
        #trace.write("************* \n" )
        #trace.close()
