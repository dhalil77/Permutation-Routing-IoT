...
# === Routing Permutation
LOG_ROUPE_DIO_TX                    = {u'type': u'roupe.dio.tx',                u'keys': [u'_mote_id',u'packet']}
LOG_ROUPE_DIO_RX                    = {u'type': u'roupe.dio.rx',                u'keys': [u'_mote_id',u'packet']}
LOG_ROUPE_DAO_TX                    = {u'type': u'roupe.dao.tx',                u'keys': [u'_mote_id',u'packet']}
LOG_ROUPE_DAO_RX                    = {u'type': u'roupe.dao.rx',                u'keys': [u'_mote_id',u'packet']}
LOG_ROUPE_DIS_TX                    = {u'type': u'roupe.dis.tx',                u'keys': [u'_mote_id',u'packet']}
LOG_ROUPE_DIS_RX                    = {u'type': u'roupe.dis.rx',                u'keys': [u'_mote_id',u'packet']}
LOG_ROUPE_CHURN                     = {u'type': u'roupe.churn',                 u'keys': [u'_mote_id',u'rank',u'preferredParent']}
LOG_ROUPE_LOCAL_REPAIR              = {u'type': u'roupe.local_repair',          u'keys': [u'_mote_id']}
